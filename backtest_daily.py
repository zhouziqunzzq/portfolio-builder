...
allocator = StockAllocator(
    sector_weights=sector_weights,         # Date × Sector
...
stock_weights = allocator.compute_stock_weights()
print(stock_weights.tail())
print("Equity exposure per date:")
print(stock_weights.sum(axis=1).tail())
